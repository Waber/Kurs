...
class ItemTest {
    ...
    @Test
    public void shouldThrowExceptionIfItemNameIsNULL()
    {
        IllegalArgumentException exception = assertThrows(
                IllegalArgumentException.class, () -> new Item(null,5.50));
        assertEquals("Wrzuciłeś przedmiot bez nazwy",exception.getMessage());
    }
